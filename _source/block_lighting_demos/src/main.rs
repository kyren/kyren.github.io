...
use stdweb::web::event::{
    MouseDownEvent, MouseEnterEvent, MouseLeaveEvent, MouseUpEvent, ResizeEvent,
};
...
fn main() {
    ...
    canvas.add_event_listener(move |click: MouseDownEvent| {
        console!(log, "mouse down {} {}", click.offset_x(), click.offset_y());
    });

    canvas.add_event_listener(move |click: MouseUpEvent| {
        console!(log, "mouse up {} {}", click.offset_x(), click.offset_y());
    });

    canvas.add_event_listener(move |click: MouseEnterEvent| {
        console!(log, "mouse enter {} {}", click.offset_x(), click.offset_y());
    });

    canvas.add_event_listener(move |click: MouseLeaveEvent| {
        console!(log, "mouse leave {} {}", click.offset_x(), click.offset_y());
    });
